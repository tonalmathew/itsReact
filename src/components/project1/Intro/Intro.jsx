    ...
    <div className="Intro">
      ...
      <div className="container">
        ...
        <div className="buttons">
          <button className='button flex justify-center items-center email bg-white text-black'>
          ...
          <button className='button button flex justify-center items-center linkedin'>
